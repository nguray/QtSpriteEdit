    ...
    : QMainWindow(parent)
{
    ...
    connect(m_colorsbar,&colorsbar::foreGroundColorChanged,m_editarea,&editarea::setForeGroundColor);
    connect(m_colorsbar,&colorsbar::backGroundColorChanged,m_editarea,&editarea::setBackGroundColor);

    connect(m_spritesbar,&spritesbar::selectSpriteChanged,m_editarea,&editarea::setEditSprite);
...
void MainWindow::createActions()
{
    ...
    rectangleModeAct = new QAction(QIcon(":/res/RectangleIcon.png"),"Pencil",this);
    rectangleModeAct->setCheckable(true);
    connect(rectangleModeAct,&QAction::triggered,this, &MainWindow::setRectangleMode);

    ellipseModeAct = new QAction(QIcon(":/res/EllipseIcon.png"),"Pencil",this);
    ellipseModeAct->setCheckable(true);
    connect(ellipseModeAct,&QAction::triggered,this, &MainWindow::setEllipseMode);
